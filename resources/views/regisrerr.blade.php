                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7 mt-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-2">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="/regist/create">
                                            @csrf
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="level" id="inputEmail" type="text" placeholder="Enter your level" />
                                                <label for="inputEmail">Level User</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
